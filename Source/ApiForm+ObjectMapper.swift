...
public class ApiFormMappableResponse<ModelType:Object where ModelType:ApiMappable> {
...
public class ApiMappableForm<ModelType:Object where ModelType:ApiMappable>
{
